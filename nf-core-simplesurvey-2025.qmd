...
As of March 18th 2025, we had `nr_slack_members` people on slack. This means we have an approximate response rate of `r round((nr_responses / nr_slack_members) * 100, 1)`%.
