...
As of March 18th 2025, we had `nr_slack_members` people on slack. This means we have an approximate response rate of `r (nr_responses / nr_slack_members) * 100`%.
...
ggplot(
  ...
  labs(title = "Type of respondee", 
     subtitle = "Users only run pipelines, Developers alsocode pipelines, Snakemake developers is a survey troll", 
     x = "Score",
     y = "Count", 
     caption = paste("Based on", nr_responses, "responses to the spring 2025 nf-core community survey")
  )
